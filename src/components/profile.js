...
export const Profile =()=>{
    ...
    useEffect(()=>{
        ...
        const pq = query(postRef, where("email", "==", loggedInUser.email))
    ...
    return(
        <div className="container-fluid profileBg pt-3">
            <div className="container border profile rounded  bg bg-white">
                ...
                <div>
                    <div className="d-flex profile-info  p-3">
                        <div className="d-flex profile-info  w-50">
                            ...
                            <div className="w-75 bimbo">
                                ...
                                <h6 className="email">{loggedInUser.email}</h6>
                            </div> 
                        </div>
                        <div>
                            <Link to="/editProfile" className="btn btn-sm bg-magenta">Edit Profile</Link>
                        </div>
                    </div>
                    <div>
                    ...
                    <div>
                        <ul className="nav nav-pills mb-3  d-flex flex-row shadow justify-content-between profile-navpills rounded navpills-pad" id="pills-tab" role="tablist">
                            <li className="nav-item navpills-pad" role="presentation">
                            ...
                            <li className="nav-item navpills-pad" role="presentation">
                                <button className="nav-link" id="pills-following-tab" data-bs-toggle="pill" data-bs-target="#pills-following" type="button" role="tab" aria-controls="pills-following" aria-selected="false">FOLLOWING</button>
                            </li>
                            <li className="nav-item navpills-pad" role="presentation">
                                <button className="nav-link" id="pills-followers-tab" data-bs-toggle="pill" data-bs-target="#pills-followers" type="button" role="tab" aria-controls="pills-followers" aria-selected="false">FOLLOWERS</button>
                            </li>
                        </ul>
                        <div className="tab-content" id="pills-tabContent">
                            ...
                            return(
                                <div key={index} className="my-2 bg bg-white p-1 m-1">
